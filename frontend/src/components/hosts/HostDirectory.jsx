...
const HostDirectory = () => {
    ...
    if (selectedFilter !== "all") {
      filtered = filtered.filter(
        (host) =>
          ...
          host.specialties.some(
            (specialty) =>
              specialty &&
              specialty.toLowerCase() === selectedFilter.toLowerCase()
          )
      );
    }
    ...
    if (searchTerm.trim() !== "") {
      ...
      filtered = filtered.filter(
        (host) =>
          ...
          (host.location &&
            host.location.toLowerCase().includes(searchTermLower)) ||
  ...
  const viewHostProfile = async (hostId) => {
    ...
    try {
      ...
      setProfileError(
        "Could not retrieve host information. Please try again later."
      );
    } finally {
  ...
  const handleFeedbackSubmit = async (type) => {
    ...
    try {
      ...
      console.log(
        `Submitting ${type} feedback for host ${selectedHost._id}: ${feedbackMessage}`
      );
      ...
      return (
        <div className="HostProfileError">
          ...
          <div className="HostProfileErrorActions">
            <button
              className="HostProfileBackButton"
        ...
        <div className="HostProfileHeader">
          <div className="HostProfileHeaderContent">
            <div className="HostProfileAvatarContainer">
              ...
              />
              {selectedHost.isActive && (
                <span className="HostProfileStatusBadge">Available</span>
              )}
            </div>

            <div className="HostProfileBasicInfo">
              <h1 className="HostProfileName">{selectedHost.name}</h1>
              <p className="HostProfileTitle">
                {selectedHost.title ||
                  selectedHost.expertise ||
                  "Professional Host"}
              </p>
              ...
              <div className="HostProfileRatingContainer">
                <div className="HostProfileRating">
                  ...
                  <span>
                    {selectedHost.rating
                      ? parseFloat(selectedHost.rating).toFixed(1)
                      : "New"}
                  </span>
                  {selectedHost.totalReviews > 0 && (
                    <span className="HostProfileReviewCount">
                      ({selectedHost.totalReviews} review
                      {selectedHost.totalReviews !== 1 ? "s" : ""})
                    </span>
                  )}
                </div>
            ...
            <div className="HostProfileActions">
              <button
                className="HostProfileBookButton"
                onClick={() => handleBookAppointment(selectedHost._id)}
              >
                Book Appointment
              </button>
              <button
                className="HostProfileContactButton"
                onClick={() => handleContactHost(selectedHost._id)}
              >
            ...
            <div className="HostProfileAbout">
              ...
              <div className="HostProfileSection">
                ...
                <div className="HostProfileSpecialties">
                  ...
                  selectedHost.specialties.length > 0 ? (
                    selectedHost.specialties.map((specialty, index) => (
                      <span key={index} className="HostProfileSpecialtyTag">
                        {specialty}
                      </span>
                    ))
                  ) : (
              ...
              <div className="HostProfileDetailsGrid">
                ...
                <div className="HostProfileDetailCard">
                  ...
                  <div className="HostProfileDetailContent">
                    ...
                    <p>
                      {selectedHost.sessionLength
                        ? `${selectedHost.sessionLength} minutes`
                        : "Not specified"}
                    </p>
                  </div>
                </div>
                ...
                {selectedHost.languages && (
                  <div className="HostProfileDetailCard">
                    ...
                    <div className="HostProfileDetailContent">
                      <h3>Languages</h3>
                      <p>
                        {Array.isArray(selectedHost.languages)
                          ? selectedHost.languages.join(", ")
                          : selectedHost.languages}
                      </p>
                    </div>
                  </div>
          ...
          {selectedTab === "services" && (
            <div className="HostProfileServices">
              ...
              {selectedHost.services && selectedHost.services.length > 0 ? (
                <div className="HostProfileServicesGrid">
                  {selectedHost.services.map((service, index) => (
                    <div key={index} className="HostProfileServiceCard">
                      <h3 className="HostProfileServiceTitle">
                        {service.name}
                      </h3>
                      <p className="HostProfileServiceDescription">
                        {service.description}
                      </p>
                      ...
                      {service.price && (
                        <div className="HostProfileServicePrice">
                          ${service.price}
                          {service.priceType && (
                            <span className="HostProfileServicePriceType">
                              /{service.priceType}
                            </span>
                          )}
                        </div>
                ...
                <p className="HostProfileNoContent">
                  This host hasn't added any services yet.
                </p>
              )}
            </div>
          )}
              ...
              <div className="HostProfileReviewsHeader">
                ...
                <div className="HostProfileRatingSummary">
                  ...
                  <div className="HostProfileRatingText">
                    <p>
                      Based on {selectedHost.totalReviews || 0} review
                      {selectedHost.totalReviews !== 1 ? "s" : ""}
                    </p>
                  </div>
                </div>
                    ...
                    <div key={index} className="HostProfileReviewCard">
                      <div className="HostProfileReviewHeader">
                        <div className="HostProfileReviewerInfo">
                          ...
                          />
                          <div>
                            <h3 className="HostProfileReviewerName">
                              {review.reviewerName}
                            </h3>
                            <p className="HostProfileReviewDate">
                              {review.date}
                            </p>
                          </div>
                        </div>
                        <div className="HostProfileReviewRating">
                          {Array.from({ length: 5 }).map((_, i) => (
                            <FaStar
                              key={i}
                              className={`HostProfileReviewStar ${
                      ...
                      <p className="HostProfileReviewContent">
                        {review.content}
                      </p>

                      {review.hostReply && (
                        <div className="HostProfileReviewReply">
                          <h4 className="HostProfileReplyHeader">
                            Host Response:
                          </h4>
                          <p className="HostProfileReplyContent">
                            {review.hostReply}
                          </p>
                        </div>
                      )}
              ...
              {selectedHost.availabilityCalendar ? (
                <div className="HostProfileCalendarContainer">
                  ...
                  <p className="HostProfileCalendarPlaceholder">
                    Calendar integration coming soon. For now, please book an
                    appointment to see available times.
                  </p>
                </div>
              ) : (
            ...
            <div className="HostProfileFeedback">
              ...
              <div className="HostProfileFeedbackSection">
                    ...
                    {selectedHost.feedback.map((item, index) => (
                      <div key={index} className="HostProfileFeedbackItem">
                        <div className="HostProfileFeedbackHeader">
                          <span
                            className={`HostProfileFeedbackType ${item.type}`}
                          >
                            {item.type === "positive" ? (
                              <FaThumbsUp />
                            ) : (
                          ...
                          <span className="HostProfileFeedbackDate">
                            {item.date}
                          </span>
                        </div>
                        <p className="HostProfileFeedbackContent">
                          {item.message}
                        </p>
                      </div>
                    ))}
                ...
                <div className="HostProfileFeedbackActions">
                  <button
                    className="HostProfileFeedbackButton"
              ...
              {showFeedbackForm && (
                <div className="HostProfileFeedbackForm">
                  <h3>Your Feedback</h3>
                  <p>
                    Help us improve by sharing your experience with this host
                  </p>
  ...
  return (
    <div className="HostDirectoryContainer">
      <header className="HostDirectoryHeader">
        ...
        <p className="HostDirectorySubheading">
          Browse our selection of qualified professionals ready to help you
        </p>
        ...
        <div className="HostDirectoryCategoriesFilter">
          <button
            className={`HostDirectoryCategoryButton ${
          ...
          {getUniqueSpecialties().map((specialty) => (
            <button
              key={specialty}
              className={`HostDirectoryCategoryButton ${
                selectedFilter === specialty ? "active" : ""
              }`}
      ...
      {error && (
        <div className="HostDirectoryError">
          ...
          <button
            className={`HostDirectoryRetryButton ${
              isRetrying ? "retrying" : ""
            }`}
            onClick={retryFetch}
            disabled={isRetrying}
        ...
        {filteredHosts.length === 0 && !error ? (
          <div className="HostDirectoryNoResults">
            ...
            {(searchTerm || selectedFilter !== "all") && (
              <button
                className="HostDirectoryClearFiltersButton"
                onClick={() => {
                  clearSearch();
              ...
              <div key={host._id} className="HostDirectoryCard">
                <div className="HostDirectoryCardHeader">
                  <div className="HostDirectoryAvatarContainer">
                    ...
                    />
                    {host.isActive && (
                      <span className="HostDirectoryStatusBadge">
                        Available
                      </span>
                    )}
                  </div>
                  <div className="HostDirectoryCardInfo">
                    ...
                    <p className="HostDirectoryCardTitle">
                      {host.title || host.expertise || "Professional Host"}
                    </p>
                ...
                <div className="HostDirectoryCardSpecialties">
                  {host.specialties &&
                    host.specialties.map((specialty, index) => (
                      <span key={index} className="HostDirectorySpecialtyTag">
                        {specialty}
                      </span>
                    ))}
                </div>
