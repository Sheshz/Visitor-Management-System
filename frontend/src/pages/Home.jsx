    ...
    <div style={styles.container}>
      ...
      <header style={styles.header}>
        ...
        <nav style={styles.nav}>
          ...
          <a href="#experts" style={styles.navLink}>Our Experts</a>
      ...
      <div style={styles.heroSection}>
        ...
        <p style={styles.heroDescription}>
          GetePass Pro connects you with experts across various fields including healthcare, engineering, finance, and life coaching for personalized consultations and guidance.
        </p>
      ...
      <div id="features" style={styles.section}>
        ...
        <div style={isMobile ? { display: 'flex', flexDirection: 'column', gap: '24px' } : styles.featuresGrid}>
          <div style={styles.featureCard}>
            ...
            <div>
              ...
              <p style={styles.featureText}>
                Book meetings with experts in seconds with our intuitive scheduling system and receive instant confirmations.
              </p>
            </div>
          </div>
          
          <div style={styles.featureCard}>
            <div style={{...styles.featureIcon, backgroundColor: '#cffafe', color: '#0891b2'}}>
              <svg style={{ width: '24px', height: '24px' }} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
              ...
              <p style={styles.featureText}>
                Connect with thoroughly vetted professionals with verified credentials and expertise in their fields.
              </p>
            </div>
          </div>
          
          <div style={styles.featureCard}>
            <div style={{...styles.featureIcon, backgroundColor: '#f3e8ff', color: '#7e22ce'}}>
              <svg style={{ width: '24px', height: '24px' }} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
              ...
              <p style={styles.featureText}>
                End-to-end encrypted video consultations with sophisticated privacy controls to protect sensitive discussions.
              </p>
            </div>
          </div>
        </div>
      ...
      <div id="how-it-works" style={{...styles.section, marginTop: '24px'}}>
        ...
        <div style={isMobile ? { display: 'flex', flexDirection: 'column', gap: '32px' } : styles.stepsGrid}>
          <div style={styles.stepItem}>
            <div style={styles.stepNumber}>1</div>
            <h3 style={styles.stepTitle}>Create an Account</h3>
            <p style={styles.stepText}>
              Sign up in minutes and complete your profile to help us match you with the right experts.
            </p>
          </div>
          ...
          <div style={styles.stepItem}>
            ...
            <p style={styles.stepText}>
              Explore our network of professionals across various categories and review their credentials.
            </p>
          </div>
          ...
          <div style={styles.stepItem}>
            ...
            <p style={styles.stepText}>
              Schedule a session at your convenience and meet virtually through our secure platform.
            </p>
          </div>
        </div>
      </div>
      ...
      <div id="experts" style={{...styles.section, marginTop: '24px'}}>
        ...
        <div style={isMobile ? { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' } : styles.expertsGrid}>
      ...
      <div style={styles.gradientSection}>
        ...
        <p style={styles.gradientText}>
          Are you a professional looking to connect with clients? Join our network of experts and start offering your services through GetePass Pro.
        </p>
        <a href="/apply-host" style={styles.whiteButton}>
      ...
      <div style={{...styles.section, marginTop: '24px'}}>
        ...
        <div style={isMobile ? { display: 'flex', flexDirection: 'column', gap: '24px' } : styles.testimonialsGrid}>
      ...
      <div style={styles.gradientSection}>
        ...
        <p style={styles.gradientText}>
          Join thousands of users who are transforming their lives through expert guidance and consultation.
        </p>
        <div style={isMobile ? { display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'center' } : { display: 'flex', flexDirection: 'row', gap: '16px', justifyContent: 'center' }}>
